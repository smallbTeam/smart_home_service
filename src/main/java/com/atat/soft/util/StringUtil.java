...
public abstract class StringUtil extends org.apache.commons.lang.StringUtils {
     ...
     * @return
     */
    public static String arrayToDelimited(String[] value, String delimiter, boolean prepend, boolean append) {
     ...
     * @return
     */
    public static String arrayToDelimited(Object[] value, String delimiter, boolean prepend, boolean append,
    ...
    public static String fromTemplate(String template, Map<String, String> params, String prefix, String surfix) {
     ...
     * @return
     */
    public static String asteriskByString(String str) {
     ...
     * @return
     */
    public static String getRequestMessage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        // 请求参数
        String requestMessage = request.getParameter("requestMessage");
        if (!StringUtil.isEmpty((requestMessage))) {
            requestMessage = HtmlEncodeUtil.decode(requestMessage);
        }
        // POST取参
        if (StringUtil.isEmpty(requestMessage)) {
            requestMessage = getRequestStringUtf8(request, response);
        }
     ...
     * 第二个是参数的param，DTO的属性名必须和占位符中的参数名完全一致才能替换（注意大小写）。
     * 
     * @param str
     * @param param
     * @return
